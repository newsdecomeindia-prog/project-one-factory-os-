...
exports.enforceDepartmentAccess = exports.enforcePlantAccess = exports.authorizePermissions = exports.authenticateJWT = exports.requirePermission = exports.requireAuth = exports.correlationMiddleware = exports.rateLimiter = exports.extractStringParam = exports.JWT_SECRET = void 0;
...
exports.authenticateJWT = exports.requireAuth;
const authorizePermissions = (permissionCodes) => {
    return (req, res, next) => {
        ...
        return res.status(403).json({
            success: false,
            error: `Access denied. Required permissions: ${permissionCodes.join(', ')}`,
        });
    };
};
