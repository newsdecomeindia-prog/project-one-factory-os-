...
export const LayoutShell: React.FC<LayoutShellProps> = ({ children, activeTab, setActiveTab }) => {
  ...
  const navigation = [
    ...
    { id: 'ipqc', name: 'In-Process QA', icon: Activity, perm: 'ipqc:read' },
    { id: 'ncr', name: 'NCR / CAPA', icon: ShieldCheck, perm: 'ncr:read' },
    { id: 'transfers', name: 'Stock Transfers', icon: Boxes, perm: 'stocktransfer:read' },
