...
export const LayoutShell: React.FC<LayoutShellProps> = ({ children, activeTab, setActiveTab }) => {
  ...
  const navigation = [
    ...
    { id: 'bom', name: 'BOM Master', icon: Layers, perm: 'bom:read' },
    { id: 'workorders', name: 'Work Orders', icon: ClipboardList, perm: 'workorder:read' },
    { id: 'materialissues', name: 'Material Issue', icon: PackageMinus, perm: 'materialissue:read' },
    { id: 'executions', name: 'Production Execution', icon: Settings, perm: 'productionexecution:read' },
    { id: 'receipts', name: 'Production Receipt', icon: PackagePlus, perm: 'productionreceipt:read' },
    { id: 'ipqc', name: 'In-Process QA (IPQC)', icon: ShieldCheck, perm: 'ipqc:read' },
    { id: 'ncr', name: 'NCR / CAPA', icon: FileSearch, perm: 'ncr:read' },
    { id: 'stocktransfers', name: 'Stock Transfers', icon: Factory, perm: 'stocktransfer:read' },
    { id: 'fgstock', name: 'FG Stock', icon: Boxes, perm: 'stock:read' },
    { id: 'customers', name: 'Customer Master', icon: Users, perm: 'customer:read' },
    { id: 'enquiries', name: 'Sales Enquiry', icon: ClipboardList, perm: 'sales:enquiry' },
    { id: 'quotations', name: 'Quotations', icon: ClipboardList, perm: 'sales:quotation' },
    { id: 'salesorders', name: 'Sales Orders', icon: PackagePlus, perm: 'sales:order' },
    { id: 'deliveryplanning', name: 'Delivery Planning', icon: Factory, perm: 'sales:delivery' },
    { id: 'salesreports', name: 'Sales Reports', icon: BarChart3, perm: 'sales:report' },
    { id: 'reports', name: 'Production Reports', icon: BarChart3, perm: 'stock:read' },
