...
router.get('/', requireAuth, requirePermission('materialissue:read'), async (req: Request, res: Response) => {
  try {
...
router.post('/', requireAuth, requirePermission('materialissue:create'), async (req: Request, res: Response) => {
  try {
